...
export const modules: ModuleItem[] = [
  {
    ...
    title: "Sales & CRM",
    description:
      "Pipelines, quotes, orders, and customer 360 - connected to every invoice and shipment.",
    icon: "grid",
  ...
  },
  {
    ...
    title: "Accounting",
    description:
      "Double-entry ledger, tax, multi-currency, bank feeds, and reporting that closes a month on time.",
    icon: "trend",
  ...
  },
  {
    ...
    title: "Inventory",
    description:
      "Multi-warehouse stock, lot and serial tracking, cycle counts, and reorder rules that just work.",
    icon: "stack",
  ...
  },
  {
    ...
    title: "HR & Payroll",
    description:
      "Time-off, onboarding, payroll, and an org chart your people actually keep looking at.",
    icon: "user",
  ...
  },
  {
    ...
    title: "Projects",
    description:
      "Boards, Gantt, timesheets, and budgets - tied to invoices so billable work bills itself.",
    icon: "blocks",
  ...
  },
  {
    ...
    title: "Manufacturing",
    description:
      "Bills of materials, work orders, shop-floor routing, and MRP without the PhD.",
    icon: "gear",
  ...
  },
  {
    ...
    title: "Purchasing",
    description:
      "Vendors, RFQs, purchase orders, and receiving - with three-way match that actually matches.",
    icon: "cart",
  ...
  },
  {
    ...
    title: "Helpdesk",
    description:
      "Tickets, SLAs, and a customer portal, sitting on the same CRM record as every order.",
    icon: "chat",
    iconColor: "bg-[var(--moss)]",
  },
];
