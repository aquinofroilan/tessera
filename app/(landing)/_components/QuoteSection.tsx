    ...
    return (
        <section className="px-0 pt-10 pb-30">
            <div className="mx-auto w-full max-w-310 px-7">
                <blockquote
                    className="font-display reveal mx-auto max-w-[22ch] text-center text-[clamp(32px,4.8vw,58px)] leading-[1.12] font-[320] tracking-tight italic"
                    data-reveal>
                ...
                <p
                    className="reveal mt-9 text-center font-mono text-xs tracking-widest text-(--ink-soft) uppercase"
                    data-reveal>
